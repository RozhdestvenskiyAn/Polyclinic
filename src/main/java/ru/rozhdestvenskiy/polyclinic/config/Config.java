package ru.rozhdestvenskiy.polyclinic.config;
...
import ru.rozhdestvenskiy.polyclinic.web.soap.exception.DetailSoapFaultDefinitionExceptionResolver;
...
public class Config extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema articlesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://polyclinic.ru/soap");
    ...
    public XsdSchema articlesSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsds/schedule.xsd"));
    }
